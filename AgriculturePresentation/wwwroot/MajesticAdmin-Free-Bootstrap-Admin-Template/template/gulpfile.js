...
gulp.task('replacePath', function(){
    var replacePath1 = gulp.src(['./pages/*/*.html'], { base: "./" })
        .pipe(replace('="images/', '="/MajesticAdmin-Free-Bootstrap-Admin-Template/template/images/'))
        .pipe(replace('href="pages/', 'href="/MajesticAdmin-Free-Bootstrap-Admin-Template/template/pages/'))
        .pipe(replace('href="documentation/', 'href="/MajesticAdmin-Free-Bootstrap-Admin-Template/template/documentation/'))
        .pipe(replace('href="index.html"', 'href="/MajesticAdmin-Free-Bootstrap-Admin-Template/template/index.html"'))
        .pipe(gulp.dest('.'));
